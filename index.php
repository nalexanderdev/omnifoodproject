...
I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                ...
                <form method="post" action="mailer.php" class="contact-form">
                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            if($_GET['success'] == -1) {
                                echo "<div class=\"form-messages error\">Whoops! Something went wrong, please try again.</div>";
                        }
                        ?>
                    </div>
        ...
        <footer>
            ...
            <div class="row">
                <p>
                    Copyright &copy; 2016 by Omnifood. All rights reserved<br>This webpage was worked on by myself Nick Alexander as part for the course "Design and Develop a Killer Website Using HTML5 and CSS3" by Jonas Schmedtmann. 
                </p>
